...
training_0 <- read.csv("pml-training.csv")
...
Since there are many features, we will use Random Forest algorithm because it automatically selects most relavant features and is robust to correlated covariates & outliers in general. We will use 8-fold cross validation when applying the algorithm.

```{r}
library(randomForest)
control_rf <- trainControl(method="cv", 8)
